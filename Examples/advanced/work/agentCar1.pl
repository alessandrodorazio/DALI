...
asserisci_ontologia(var_Semaforo,[],attraversamento):-retractall(stato_attraversamento(var__,var__)),assertz(stato_attraversamento('concesso',var_Semaforo)).

eve(init(var_Id,var_Priorita)):-assertz(info_vettura(var_Id,var_Priorita)).

eve(arrivo_al_semaforo(var_Semaforo)):-assertz(stato_attraversamento('no')),format('Sono arrivato presso incrocio del semaforo ~w',var_Semaforo),nl,a(chiedo_di_attraversare(var_Semaforo)).

a(chiedo_di_attraversare(var_Semaforo)):-info_vettura(var_Id,var_Priorita),write('Sto per chiedere al semaforo di attraversare'),nl,a(message(var_Semaforo,send_message(richiesta_attraversamento(var_Id,var_Priorita),var_Me))).

attraverso:-write('').

evi(attraverso):-stato_attraversamento(var_Y,var_Semaforo),'concesso'==var_Y,retractall(stato_attraversamento(var__,var_Semaforo)),assertz(stato_attraversamento('incorso',var_Semaforo)),a(message(agentSemaphore1,accept_proposal(test,[],var_Me))),write('Il semaforo mi ha appena concesso ad attraversare incrocio, dunque lo attraverso'),nl,a(termino_attraversamento).

a(termino_attraversamento):-info_vettura(var_Id,var__),stato_attraversamento(var_X,var_Semaforo),var_X=='incorso',retractall(stato_attraversamento(var__,var_Semaforo)),assertz(stato_attraversamento('terminato',var_Semaforo)),write('Ho attraversato incrocio, dunque comunico al semaforo di aver terminato'),nl,a(message(var_Semaforo,send_message(termine_attraversamento(var_Id),var_Me))).
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_353877,var_Ontology,_353881),_353871),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_353915)),a(message(var_Ag,propose(var_A,[_353915],var_AgI))),retractall(ext_agent(var_Ag,_353953,var_Ontology,_353957)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_353751,var_Ontology,_353755),_353745),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_353821,var_Ontology,_353825)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_353639,var_Ontology,_353643),_353633),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_353695,var_Ontology,_353699)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_353203),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_353237),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_353019).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_352867),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_352815),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_352691,_352693)),clause(agente(_352713,_352715,_352717,var_S),_352709),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_352485,_352487,_352489,var_S),_352481),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_352585,[]),repeat,read(_352585,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_352585).
